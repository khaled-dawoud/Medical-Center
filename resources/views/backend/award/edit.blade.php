            ...
            <div class="container">
                <form action="{{ route('admin.award.update' ,$award->id) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="date" multiple class="form-control" type="date"  value="{{ $award->date }}">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="title" multiple class="form-control" type="text" value="{{ $award->title }}">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="exampleFormControlTextarea1" name="desc" rows="5">{{ $award->desc }}</textarea>
                        </div>
                    </div>
                    <!-- end row -->
