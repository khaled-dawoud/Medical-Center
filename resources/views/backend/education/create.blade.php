            ...
            <div class="container">
                <form action="{{ route('admin.education.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="uni_name" multiple class="form-control" type="text">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="uni_major" multiple class="form-control" type="text">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="start" multiple class="form-control" type="text">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="end" multiple class="form-control" type="text">
                        </div>
                    </div>
                    <!-- end row -->
                    ...
                    <button type="submit"  class="btn btn-primary btn-rounded waves-effect waves-light mt-5 mb-3">Add Education</button>
                </form>
